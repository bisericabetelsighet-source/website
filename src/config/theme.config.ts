...
export const authors = [
  ...
  },
  {
    slug: "samuel-bumbar",
    name: "Samuel BUMBAR",
    bio: "Membru comitet, responsabil pentru departamentul Media",
    longBio:
  ...
  },
  {
    slug: "stefan-mois",
    name: "Ștefan MOIȘ",
    bio: "Membru comitet, responsabil pentru departamentul Primire",
    longBio:
...
export const tags = [
  ...
  { slug: "baptism", name: "Botez Nou Testamentar" },
